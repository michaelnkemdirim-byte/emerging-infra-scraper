#!/usr/bin/env python3
"""
Scraper for TechEconomy Nigeria
Website: https://techeconomy.ng
Type: WordPress news site
Focus: Technology, business, economy, fintech, infrastructure
"""
...
def scrape_techeconomy():
    """Main scraping function for TechEconomy"""
    print("="*70)
    print("Scraping TechEconomy Nigeria (techeconomy.ng)")
    print("="*70)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Scrape TechEconomy for infrastructure news')
    parser.add_argument('--output', default='techeconomy_data.csv', help='Output CSV file')
    args = parser.parse_args()

    data = scrape_techeconomy()
