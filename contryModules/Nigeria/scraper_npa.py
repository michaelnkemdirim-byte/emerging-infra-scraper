#!/usr/bin/env python3
"""
Nigerian Ports Authority (NPA) - Port Infrastructure Scraper
Scrapes port development, maritime infrastructure, and terminal projects
"""
...
# Configuration
BASE_URL = "https://nigerianports.gov.ng"
API_URL = f"{BASE_URL}/wp-json/wp/v2/posts"
COUNTRY = "Nigeria"
SOURCE_NAME = "Nigerian Ports Authority"
...
EXCLUDE_PATTERNS = [
    ...
    # Events/training/ceremonies
    'management retreat', 'ministerial retreat', 'board retreat', 'retreat for',
    'workshop', 'training session', 'training school', 'capacity building',
    'emergency drill', 'evacuation drill', 'fire drill',
    # Awards/ceremonies
    'award', 'honours', 'productivity award', 'recognition',
    'congratulatory', 'congratulations', 'felicitate',
    # People
    ...
    # Generic meetings (keep strategic/infrastructure meetings)
    'photo news', 'courtesy visit', 'courtesy call',
    # Research/academic (not infrastructure projects)
    'research team from', 'peacekeeping training'
]
...
def process_post(post: Dict) -> Dict[str, Any]:
    ...
    try:
        ...
        # NPA is all about ports/maritime
        category = "port"
...
def scrape_all_posts():
    ...
    print(f"\n  Successfully processed {len(all_data)} port/maritime articles")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Nigerian Ports Authority (NPA)')
    parser.add_argument('--output', '-o', default='npa_data.csv', help='Output CSV file')
    ...
    if data:
        ...
        print("No port/maritime articles collected!")
