#!/usr/bin/env python3
"""
Scraper for TechTrendsKE
Website: https://techtrendske.co.ke
Type: WordPress news site
Focus: Technology, business, infrastructure, cybersecurity
"""
...
# Configuration
BASE_URL = 'https://techtrendske.co.ke'
...
def scrape_techtrendske():
    """Main scraping function for TechTrendsKE"""
    print("="*70)
    print("Scraping TechTrendsKE (techtrendske.co.ke)")
    print("="*70)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Scrape TechTrendsKE for infrastructure news')
    parser.add_argument('--output', default='techtrendske_data.csv', help='Output CSV file')
    args = parser.parse_args()

    data = scrape_techtrendske()
