#!/usr/bin/env python3
"""
Rwanda Ministry of Finance - News Scraper
Scrapes news articles from minecofin.gov.rw (current month only)
"""
...
# Configuration
BASE_URL = "https://www.minecofin.gov.rw"
...
def scrape_all_news():
    """Scrape all news articles from minecofin.gov.rw (current month only)"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Rwanda Ministry of Finance news (current month)')
    parser.add_argument('--output', '-o', default='minecofin_data.csv', help='Output CSV file')
    ...
    if data:
        ...
        print(f"No articles from {CURRENT_YEAR}-{CURRENT_MONTH:02d} collected!")
