#!/usr/bin/env python3
"""
Bizcommunity - RSS Feed Scraper
Scrapes infrastructure, energy, technology, and economic news from bizcommunity.com
"""
...
RSS_FEEDS = {
    'Energy & Mining': 'https://www.bizcommunity.com/rss/196/355.html',
    'Construction & Engineering': 'https://www.bizcommunity.com/rss/196/360.html',
    'ICT': 'https://www.bizcommunity.com/rss/196/379.html',
    'Finance': 'https://www.bizcommunity.com/rss/196/357.html',
    'Logistics & Transport': 'https://www.bizcommunity.com/rss/196/389.html'
}
...
def parse_date(date_str: str) -> str:
    ...
    try:
        # RSS date format: "Wed, 29 Oct 2025 09:58:00 +0200"
...
def scrape_all_feeds():
    ...
    print(f"Starting Bizcommunity RSS scraper")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Bizcommunity RSS feeds')
    parser.add_argument('--output', '-o', default='bizcommunity_data.csv', help='Output CSV file')
