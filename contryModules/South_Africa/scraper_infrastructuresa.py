#!/usr/bin/env python3
"""
Infrastructure South Africa - Scraper
Scrapes infrastructure news from infrastructuresa.org (current month only)
"""
...
# Configuration
BASE_URL = "https://infrastructuresa.org"
API_URL = f"{BASE_URL}/wp-json/wp/v2/posts"
COUNTRY = "South Africa"
SOURCE_NAME = "Infrastructure South Africa"
...
def is_current_month(date_str: str) -> bool:
    ...
    try:
        ...
        return date_obj.year == CURRENT_YEAR and date_obj.month == CURRENT_MONTH
    except:
        return False
...
def scrape_all_posts():
    """Scrape all posts from Infrastructure South Africa via WordPress API"""
    print(f"Starting scraper for {SOURCE_NAME}")
    print("="*60)
    print("Collecting all available articles")
    print("="*60)
    ...
    print(f"\n  Successfully processed {len(all_data)} articles")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Infrastructure South Africa (current month)')
    parser.add_argument('--output', '-o', default='infrastructuresa_data.csv', help='Output CSV file')
