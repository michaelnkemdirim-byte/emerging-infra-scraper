#!/usr/bin/env python3
"""
Burkina24 - Economic, Energy & Technology News Scraper
Scrapes economic, energy, and technology news from Burkina Faso (French language)
"""
...
# French keywords for Burkina Faso (Economic, Energy, Technology)
ECONOMIC_KEYWORDS = [
    # Finance & Banking (French)
    'finance', 'bancaire', 'banque', 'prêt', 'crédit', 'dette', 'hypothèque',
    'marché financier', 'bourse', 'capital', 'titres', 'obligations', 'trésor', 'forex',
    # Trade & Commerce (French)
    'commerce', 'exportation', 'importation', 'négoce', 'affaires', 'marchand',
    'douane', 'tarif', 'accord commercial', 'libre-échange',
    # Economy & Policy (French)
    'économique', 'économie', 'pib', 'inflation', 'déflation', 'récession',
    'politique monétaire', 'politique budgétaire', 'budget', 'taxation', 'impôt', 'revenu',
    'bceao', 'banque centrale', 'ministère de l\'économie', 'ministère des finances',
    # Investment (French)
    'investissement', 'investisseur', 'capital-risque', 'private equity',
    'investissement direct étranger', 'ide', 'portefeuille', 'actions', 'parts',
    # Technology & Finance (French)
    'fintech', 'mobile money', 'paiement numérique', 'e-commerce', 'commerce électronique',
    'blockchain', 'cryptomonnaie', 'crypto', 'bitcoin',
    # Corporate (French)
    'fusion', 'acquisition', 'introduction en bourse', 'société', 'entreprise',
    'profit', 'bénéfice', 'chiffre d\'affaires', 'dividende', 'actionnaire',
    # Energy (French)
    'énergie', 'électricité', 'puissance', 'pétrole', 'gaz', 'carburant',
    'solaire', 'énergie renouvelable', 'éolien', 'hydroélectrique', 'barrage',
    'centrale électrique', 'géothermie', 'nucléaire', 'thermique',
    # Technology (French)
    'technologie', 'numérique', 'digital', 'télécommunications', 'télécom', '5g', '4g',
    'internet', 'fibre optique', 'centre de données', 'tic', 'innovation', 'startup',
    'cybersécurité', 'e-gouvernement', 'transformation digitale'
]

# Exclude non-relevant content (French)
EXCLUDE_PATTERNS = [
    'nécrologie', 'condoléances', 'funérailles', 'décès', 'avis de décès',
    'anniversaire', 'mariage', 'fiançailles',
    'galerie photo', 'images', 'photos seulement',
    'résultat sportif', 'score', 'match de football', 'ligue de football',
...
def scrape_all_posts():
    """Scrape all posts from Ghana Business News via WordPress API"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Burkina24')
    parser.add_argument('--output', '-o', default='burkina24_data.csv', help='Output CSV file')
