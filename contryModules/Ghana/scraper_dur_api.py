#!/usr/bin/env python3
"""
Department of Urban Roads (DUR) - WordPress API Scraper
Scrapes urban roads infrastructure news and newsletters
"""
...
# Configuration
BASE_URL = "https://dur.gov.gh"
API_BASE = f"{BASE_URL}/wp-json/wp/v2"
COUNTRY = "Ghana"
SOURCE_NAME = "Department of Urban Roads"
...
def parse_post(post):
    ...
    try:
        ...
        # Category - All DUR content is urban roads/highway infrastructure
        category = 'highway'
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Department of Urban Roads')
    parser.add_argument('--output', '-o', default='dur_data.csv', help='Output CSV file')
