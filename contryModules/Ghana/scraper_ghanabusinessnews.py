#!/usr/bin/env python3
"""
Ghana Business News - Economic & Business News Scraper
...
# Configuration
BASE_URL = "https://www.ghanabusinessnews.com"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Ghana Business News')
    parser.add_argument('--output', '-o', default='ghanabusinessnews_data.csv', help='Output CSV file')
