#!/usr/bin/env python3
"""
Tech Labari - Economic & Business News Scraper
...
# Configuration
BASE_URL = "https://techlabari.com"
API_URL = f"{BASE_URL}/wp-json/wp/v2/posts"
COUNTRY = "Ghana"
SOURCE_NAME = "Tech Labari"
...
def scrape_all_posts():
    """Scrape all posts from Tech Labari via WordPress API"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Tech Labari')
    parser.add_argument('--output', '-o', default='techlabari_data.csv', help='Output CSV file')
