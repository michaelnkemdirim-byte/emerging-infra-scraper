#!/usr/bin/env python3
"""
Citi Newsroom - Economic & Business News Scraper
...
def scrape_all_posts():
    """Scrape all posts from Citi Newsroom via WordPress API"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Scrape Citi Newsroom')
    parser.add_argument('--output', '-o', default='citinewsroom_data.csv', help='Output CSV file')
